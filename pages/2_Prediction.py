...
# Function to fetch client address
...
# Initialisez le session state pour la caractéristique et le résultat de la prédiction sélectionnés
    ...
    with col1:
        ...
        if st.button('Launch Prediction'):
            ...
            with st.spinner('Loading...'):
                ...
                # Vérifier si right_score est dans la réponse et l'afficher dans une jauge
                if 'right_score' in st.session_state.prediction_result:
                    ...
                    # Calculer les positions relatives pour le texte
                    not_allowed_position = 25 - (len("Not Allowed") / 2)  # ajuster en fonction de la longueur du texte
                    loan_available_position = 75 - (len("Loan Available") / 2)  # ajuster en fonction de la longueur du texte
...
with col1: 
    # Afficher le message d'éligibilité
...
with col3:        
    # Récupérer et afficher l'image de prédiction globale  (SHAP)
    ...
    # Récupérer et afficher l'image de prédiction locale (LIME)    
...
if st.session_state.selected_feature and st.session_state.prediction_result:
    with col1:
        ...
        # Trouvez l'index de la caractéristique sélectionnée
